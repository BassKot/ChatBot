...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        best_thread = pairwise_distances_argmin(X=question_vec.reshape(1,self.embeddings_dim),Y=thread_embeddings,metric='cosine') #### YOUR CODE HERE ####
...
class DialogueManager(object):
    ...
    def generate_answer(self, question):
        ...
        intent =vself.intent_recognizer.predict(features)[0] #### YOUR CODE HERE ####
